...
--
-- Table structure for table `assisted_chat`
--

DROP TABLE IF EXISTS `assisted_chat`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `assisted_chat` (
...
INSERT INTO `friend` VALUES (8,10,1,1,'2023-02-19 12:54:31',NULL);
...
CREATE TABLE `message` (
  ...
  KEY `message_user_username_fk_2` (`receiveId`)
